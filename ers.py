...
label2=Label(f,text="Select an action: ",font=('bold',12), background="blue", fg="White")
label2.pack(side=LEFT,pady=10)
button1=Button(f,text="ADD", background="DEEPPINK", fg="White", command=add_info, width=8)
button1.pack(side=LEFT,ipadx=20,pady=10)
button2=Button(f,text="REMOVE", background="DEEPPINK", fg="white", command=remove_emp, width=8)
button2.pack(side=LEFT,ipadx=20,pady=10)
button3=Button(f,text="SEARCH", background="DEEPPINK", fg="White", command=search_emp, width=8)
button3.pack(side=LEFT,ipadx=20,pady=10)
button6=Button(f,text="CLOSE", background="DEEPPINK", fg="White", width=8, command=root.destroy)
